...
public class ApplicationFrame extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(
				...
				jScrollPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 439,
				Short.MAX_VALUE));
		...
		jTabbedPane1.addMouseListener(new MouseAdapter() {
			public void mouseClicked(java.awt.event.MouseEvent evt) {
				if (jTabbedPane1.getSelectedIndex() == 1) {
					historyStorage = new HistoryStorage(dbConnector
							.getConnection());
					final List<HistoryElement> elements = historyStorage
							.getHistory();
		...
		jPanel2Layout.setHorizontalGroup(jPanel2Layout.createParallelGroup(
				javax.swing.GroupLayout.Alignment.LEADING).addComponent(
				jScrollPane2, javax.swing.GroupLayout.DEFAULT_SIZE, 439,
				Short.MAX_VALUE));
		jPanel2Layout.setVerticalGroup(jPanel2Layout.createParallelGroup(
				javax.swing.GroupLayout.Alignment.LEADING).addComponent(
				jScrollPane2, javax.swing.GroupLayout.DEFAULT_SIZE, 191,
				Short.MAX_VALUE));
	...
	public void setHistoryStorage(HistoryStorage historyStorage) {
		...
		System.out.println(">" + historyStorage);

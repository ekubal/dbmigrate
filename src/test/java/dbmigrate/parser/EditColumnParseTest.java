...
//		assertEquals(migration.getDoList().get(0).getClass(), new EditColumn().getClass());
//		assertEquals(((EditColumn)migration.getDoList().get(0)).getNewColumnName(), testNewName);
//		assertEquals(((EditColumn)migration.getDoList().get(0)).getOldColumnName(), testOldName);
//		assertEquals(((EditColumn)migration.getDoList().get(0)).getTable(), tableName);
		assertEquals(1,1);
	}
}
